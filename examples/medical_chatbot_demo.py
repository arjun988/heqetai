    ...
    def on_llm_end(self, response: Any, **kwargs):
        ...
        if hasattr(response, 'generations') and response.generations:
            ...
            self.debugger.add_context(
                ...
                agent_id=self.patient_id,
                metadata={"timestamp": datetime.now().isoformat(), "type": "medical_advice"}
            )
...
class MedicalChatbot:
    ...
    def __init__(self, patient_id: str, debugger: AgentDebugger, gemini_api_key: str):
        ...
        self.medical_prompt = ChatPromptTemplate.from_messages([
            ("system", """You are a helpful medical assistant. You can provide general health information, 
    ...
    def _initialize_patient_context(self):
        ...
        self.debugger.add_context(
            ...
            agent_id=self.patient_id,
            metadata={"patient_id": self.patient_id, "session_start": datetime.now().isoformat()}
        )
        ...
        medical_knowledge = {
            ...
            "preventive_care": ["regular exercise", "balanced diet", "adequate sleep", "stress management"]
        }
    ...
    def chat(self, user_input: str) -> str:
        ...
        try:
            ...
            self.debugger.add_context(
                ...
                agent_id=self.patient_id,
                metadata={"timestamp": datetime.now().isoformat(), "type": "medical_response"}
            )
            ...
            self.debugger.add_context(
                ...
                agent_id=self.patient_id,
                metadata={"error_type": "medical_consultation", "timestamp": datetime.now().isoformat()}
            )
    ...
    def add_medical_context(self, context_type: str, key: str, value: str, priority: str = "medium"):
        ...
        self.debugger.add_context(
            ...
            agent_id=self.patient_id,
            metadata={"context_type": context_type, "timestamp": datetime.now().isoformat()}
        )


def create_medical_chatbots(debugger: WebPortalDebugger, gemini_api_key: str) -> Dict[str, MedicalChatbot]:
    ...
    while True:
        try:
            ...
            if random.random() < 0.8:
                ...
                chatbot.add_medical_context("emergency", "urgent_consultation", question, "critical")
...
def run_medical_chatbot_demo():
    ...
    conversation_thread = threading.Thread(
        target=simulate_medical_conversations,
        args=(chatbots,),
        daemon=True
    )
